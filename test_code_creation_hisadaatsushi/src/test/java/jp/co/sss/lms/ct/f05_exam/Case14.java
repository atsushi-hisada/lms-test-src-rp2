...
public class Case14 {
	...
	void test06() {
		...
		// 問題を取得
		List<WebElement> questionElements = webDriver.findElements(By.className("list-group"));

		// 回答を選択
		questionElements.get(0).findElements(By.tagName("input")).get(2).click();
		scrollBy("400");
		questionElements.get(1).findElements(By.tagName("input")).get(2).click();
		scrollBy("400");
		questionElements.get(2).findElements(By.tagName("input")).get(2).click();
		scrollBy("400");
		questionElements.get(3).findElements(By.tagName("input")).get(3).click();
		scrollBy("400");
		questionElements.get(4).findElements(By.tagName("input")).get(1).click();
		scrollBy("400");
		questionElements.get(5).findElements(By.tagName("input")).get(1).click();
		scrollBy("400");
		questionElements.get(6).findElements(By.tagName("input")).get(2).click();
		scrollBy("400");
		questionElements.get(7).findElements(By.tagName("input")).get(3).click();
		scrollBy("400");
		questionElements.get(8).findElements(By.tagName("input")).get(2).click();
		scrollBy("300");
		questionElements.get(9).findElements(By.tagName("input")).get(1).click();
		scrollBy("400");
		questionElements.get(10).findElements(By.tagName("input")).get(1).click();
		scrollBy("400");
		questionElements.get(11).findElements(By.tagName("input")).get(1).click();
	...
	void test08() {
		...
		// 試験結果が存在するか確認
		WebElement dateElement = webDriver.findElement(By.xpath("//td[contains(.,'50.0点')]"));
		assertTrue(dateElement.getText().contains("50.0点"));
